    ...
    *,
    ...
    if summary is None:
        ...
        fields = [
            ...
            ("SHADOW_CAPTURE_ENABLED", _safe_text(summary.get("SHADOW_CAPTURE_ENABLED"), default="unknown")),
            ("SHADOW_CAPTURE_ATTEMPTED", _safe_text(summary.get("SHADOW_CAPTURE_ATTEMPTED"), default="unknown")),
            ("SHADOW_CAPTURE_WRITTEN_COUNT", _safe_int(summary.get("SHADOW_CAPTURE_WRITTEN_COUNT"))),
            ("SHADOW_CAPTURE_DROPPED_COUNT", _safe_int(summary.get("SHADOW_CAPTURE_DROPPED_COUNT"))),
            ("SHADOW_CAPTURE_WARNING_COUNT", _safe_int(summary.get("SHADOW_CAPTURE_WARNING_COUNT"))),
            ("SHADOW_CAPTURE_STATUS", _safe_text(summary.get("SHADOW_CAPTURE_STATUS"), default="unknown")),
